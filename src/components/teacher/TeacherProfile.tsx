...
const TeacherProfile = () => {
  ...
  const [profile, setProfile] = useState({
    ...
    email: 'nguyenthib@school.edu.vn',
    ethnicity: 'Kinh',
    className: '10A1',
    subject: 'Toán học'
  });
    ...
    <div className="p-6 max-h-screen overflow-y-auto">
      ...
      <Card className="max-w-4xl">
        ...
        <CardContent className="space-y-6">
          ...
          <div>
            <h3 className="text-lg font-semibold mb-4 text-gray-700">Thông tin giảng dạy</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <Label htmlFor="className">Lớp phụ trách</Label>
                <Input
                  id="className"
              ...
              <div>
                <Label htmlFor="subject">Môn phụ trách</Label>
                <Input
                  id="subject"
