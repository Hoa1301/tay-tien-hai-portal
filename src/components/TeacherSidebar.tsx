...
const menuItems = [
  ...
  { id: 'schedule', title: 'Lịch dạy', icon: Calendar },
  { id: 'class-management', title: 'Quản lý lớp học', icon: Users },
  { id: 'answer-key', title: 'Cập nhật đáp án', icon: FileSearch },
  { id: 'student-results', title: 'Xem kết quả học sinh', icon: BarChart },
  { id: 'settings', title: 'Cài đặt', icon: Settings },
];

const TeacherSidebar: React.FC<TeacherSidebarProps> = ({ activeItem, setActiveItem, onLogout }) => {
  return (
    <Sidebar className="border-r-0">
      <SidebarHeader className="bg-school-primary p-6">
        <div className="flex flex-col items-center text-white">
          ...
          <p className="text-sm opacity-90 text-center">Hệ thống giáo viên</p>
        </div>
      </SidebarHeader>
      ...
      <SidebarFooter className="bg-school-primary p-4">
        <div className="flex items-center justify-between text-white">
          <div className="flex items-center space-x-2">
            ...
            <span className="text-sm">Nguyễn Thị B</span>
          </div>
          <Button
            variant="ghost"
            size="sm"
